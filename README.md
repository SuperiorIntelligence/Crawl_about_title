...
| منبع | نقش |
|------|-----|
| دیجی‌کالا / باسلام / دیوار | مارکت‌پلیس (فعال) |
| ترب / اسنپ / اکالا | تلاش می‌شود؛ اغلب ضدربات |
| **کشف وب (web-discovery)** | جستجوی وب برای **سایت‌های مستقل .ir** که در مارکت‌پلیس‌ها نیستند، سپس crawl قیمت |

هر جستجو هم مارکت‌پلیس‌ها را می‌گردد هم با DuckDuckGo/Bing فروشگاه‌های جدا را پیدا و قیمت‌کشی می‌کند.
